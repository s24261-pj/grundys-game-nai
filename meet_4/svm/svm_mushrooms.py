...
- Each column in the dataset represents either a feature or the target label.
- LabelEncoder transforms unique categorical values into integers, which is required for numerical computation.
- A separate encoder is created for each column to handle encoding independently.
"""
